            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text('/${totalPages}', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold),),
                ],
              ), // Row
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(texts.posts[page - 1]['title'], style: TextStyle(color: Colors.white, fontSize: 35, fontWeight: FontWeight.bold, height: 1.3),),
                    SizedBox(height: 20),
                    Row(
                      children: [
                        Container(
                    ...
                    Padding(
                      ...
                      child: Text(texts.posts[page - 1]['body'], style: TextStyle(color: Colors.white, fontSize: 15),),
                    ), // Padding
                    SizedBox(height: 20),
                    Text('READ MORE', style: TextStyle(color: Colors.white),),
                    SizedBox(height: 10),
                    ElevatedButton(
                      onPressed: () {_pageController.jumpToPage((page != 4) ? page : 0 );},
                      child: Text(''),
                    ),
                  ],
                ), // Column
